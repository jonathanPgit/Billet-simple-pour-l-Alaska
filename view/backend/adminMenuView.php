...
<ul id="adminMenu">
    ...
    <li><a href="admin.php?action=updateEmail"><button class="adminMenu" >changer l'e-mail de sécurité</br><span class="glyphicon glyphicon-envelope"></span></button></a></li>
</ul>
